...
FROM messages m JOIN user u ON u.user_id = m.sender_id
            ...
            <?php else: ?>
                <?php foreach ($messages as $m): ?>
                    ...
                    <div class="chat-message <?php echo $messageClass; ?>">
                        ...
                        <small><?php echo htmlspecialchars($m['sender_name']); ?> at <?php echo date("g:i a, M j", strtotime($m['sent_at'])); ?></small>
                    </div>
                <?php endforeach; ?>
            <?php endif; ?>
        </div>
